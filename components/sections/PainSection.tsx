...
import PainCage from './PainCage'

export default function PainSection() {
  return (
    <section id="pain" className={styles.section}>
      <div className={styles.stage}>
        {/* Dark substrate — gives glass something to frost against */}
        <div className={styles.substrate} aria-hidden="true" />

        <div className={styles.cageWrap}>
          <PainCage />
        </div>

        <div className={styles.glassPanel}>
          <span className={styles.glassBrand}>FerdiAI</span>
